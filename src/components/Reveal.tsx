...
export function Reveal({
  ...
  const ref = useCallback((node: HTMLDivElement | null) => {
    ...
    const observer = new IntersectionObserver(
      ...
      /*
        Порог 12% высоты экрана заставлял блок ждать, пока он заедет выше
        нижней кромки. На длинных секциях это читалось задержкой: контент уже
        на экране, а появляется через полэкрана прокрутки. 4% хватает, чтобы
        анимация не срабатывала на блоке, едва задевшем кадр.
      */
